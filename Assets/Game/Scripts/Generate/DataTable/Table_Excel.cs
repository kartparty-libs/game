...
using Framework;
public partial class Excel_Table : DataTableLoader<Excel_Data>
{
    public override string GetTableName() { return "Excel"; }
    protected override Excel_Data CreateItem()
    {
...
public partial class Excel_Data : IDataTable
{
	...
	public Vector3[] PosList { get; protected set; }
